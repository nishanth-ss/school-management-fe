...
function Reports() {
    ...
    const { data: students } = useFetchData(`student`, refetch, "true","true");
    ...
    const inmatePayload = {
        registration_number: selectedInmateItem?.registration_number || null,
        ...payLoad
    }
    ...
    async function postData() {
        ...
        let reportsName =
            apiUrl.id === 1 && selectedInmateItem?.registration_number
                ? `student_${selectedInmateItem?.registration_number}_report`
                : apiUrl.id === 1 && !selectedInmateItem?.registration_number
                    ? "student_report"
                    : apiUrl.id === 2
                        ? "Transaction_Report"
                        ...
                        <CardContent className="space-y-4">
                            ...
                            {apiUrl?.id === 1 && <div>
                                <Autocomplete
                                    ...
                                    getOptionLabel={(option) => `${option?.student_name} ${option?.father_name} - ${option?.registration_number}`}
